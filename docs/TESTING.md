...
| Responsive/WCAG | One `h1`, main/footer landmarks, labels, focus behavior, no overflow, and 24 CSS-pixel interactive targets at 320x800, 768x1024, 1366x768, and 1920x1080; repeat axe checks after the dynamic result appears. Lighthouse accessibility is recorded. This is not third-party WCAG certification. |
